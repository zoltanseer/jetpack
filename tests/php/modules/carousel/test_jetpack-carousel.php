...
class Test_Jetpack_Carousel extends WP_UnitTestCase {
	...
	public function test_add_data_to_container() {
		...
		$this->assertEquals( '<div class="gallery" ' . $extra . '></div>', $this->carousel->add_data_to_container(  '<div class="gallery"></div>' ) );
	}
	...
	public function test_add_data_to_container_with_utf_8_input( $input, $expected ) {
		...
		$this->assertEquals( $expected, $this->carousel->add_data_to_container( $input ) );
	}
